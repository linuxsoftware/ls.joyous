...
latex_documents = [
    (master_doc, 'Joyous.tex', 'Joyous Documentation',
     'Linuxsoftware', 'manual'),
]
...
man_pages = [
    (master_doc, 'joyous', 'Joyous Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Joyous', 'Joyous Documentation',
     author, 'Joyous', 'One line description of project.',
     'Miscellaneous'),
]
...
_yes = None # None is equivalent to giving the option name in the list format
autodoc_default_options = {'private-members':   _yes,}
#   'members':           _yes,
#   'undoc-members':     _yes,
#   'private-members':   _yes,
#   'special-members':   _yes,
#   'inherited-members': _yes,
#   'show-inheritance':  _yes, 
